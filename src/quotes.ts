export const quotes = [
  ...
  "O sucesso é uma ilusão, a vida é uma constante luta.",
  "Não importa o quanto você se esforce, sempre haverá alguém melhor do que você.",
  "As expectativas são apenas uma fonte de sofrimento.",
  "Não há nada de certo neste mundo, a não ser a incerteza.",
  "Não adianta correr, você sempre chegará tarde demais.",
  "A vida é uma montanha-russa de altos e baixos, e a maior parte do tempo você está em uma descida.",
  "Você nunca será o suficientemente bom para todos.",
  "Não há nada de novo sob o sol, apenas a mesma rotina cansativa todos os dias",
  "O fracasso é uma constante na vida, sucesso é apenas uma exceção rara.",
  "As pessoas mudam, e geralmente não para melhor.",
  "Não há nada de certo neste mundo, apenas diferentes tipos de erro.",
  "A vida é uma corrida sem fim, e você nunca chegará ao seu destino.",
  "O tempo passa, mas as coisas nunca mudam.",
  "A felicidade é apenas momentânea, logo será substituída por tristeza.",
  "As coisas boas nunca duram, então é melhor não se apegarmos a elas.",
  "O esforço é inútil, pois o destino já está traçado.",
];
